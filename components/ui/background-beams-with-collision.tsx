  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          boxShadow:
            "0 0 24px rgba(232, 65, 66, 0.06), 0 1px 1px rgba(0, 0, 0, 0.05), 0 0 0 1px rgba(232, 65, 66, 0.04), 0 0 4px rgba(232, 65, 66, 0.08), 0 16px 68px rgba(232, 65, 66, 0.05), 0 16px 68px rgba(255, 87, 34, 0.05)",
        }}
      />
    </div>
  );
